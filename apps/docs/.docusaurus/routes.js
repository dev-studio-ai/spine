            ...
            routes: [
              {
                ...
                component: ComponentCreator('/app-core/dependency-injection', 'f2d'),
                exact: true,
                sidebar: "mainSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/extensions/winston-logger', 'f86'),
                exact: true,
                sidebar: "mainSidebar"
              },
              {
                path: '/gateway/controllers-handlers',
                component: ComponentCreator('/gateway/controllers-handlers', '160'),
                exact: true,
                sidebar: "mainSidebar"
              },
              {
