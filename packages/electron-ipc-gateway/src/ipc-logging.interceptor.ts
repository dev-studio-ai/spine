 ...
 */
export class IpcLoggingInterceptor implements GatewayInterceptor<ElectronIpcBaseContext> {
  ...
  async intercept(
    ...
    this.logger.debug(`← ${route.address} ${detail}`, IpcLoggingInterceptor.name);
    return envelope;
  }
}
